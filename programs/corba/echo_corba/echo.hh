...
public:
  ...
  typedef _CORBA_ConstrType_Fix_OUT_arg< Line,Line_var > Line_out;
...
inline size_t
Echo::_alignedSize(Echo_ptr obj, size_t offset) {
  return CORBA::AlignedObjRef(obj, _PD_repoId, 13, offset);
}

inline void
Echo::_marshalObjRef(Echo_ptr obj, NetBufferedStream& s) {
  CORBA::MarshalObjRef(obj, _PD_repoId, 13, s);
}

inline void
Echo::_marshalObjRef(Echo_ptr obj, MemBufferedStream& s) {
  CORBA::MarshalObjRef(obj, _PD_repoId, 13, s);
}
